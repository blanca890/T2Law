...
<body class="min-h-screen flex items-center justify-center bg-cover bg-center relative" 
  ...
  <div class="relative z-10 w-full max-w-md bg-white rounded-lg shadow-md p-8 flex flex-col justify-center">
   ...
   <input type="password" id="password" name="password" required minlength="7"
     ...
     class="mt-1 block w-full rounded-md border-gray-300 shadow-sm 
       focus:ring-blue-500 focus:border-blue-500"
     title="Password must be at least 7 characters, include at least 1 number and 1 special character."
        ...
        <div id="pw-tooltip" class="hidden absolute left-0 top-full mt-2 w-64 
          ...
          Password must be at least 7 characters, include at least 1 number and 1 special character.
        </div>
      </div>
